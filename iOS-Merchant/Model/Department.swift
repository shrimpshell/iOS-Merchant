...
class CDepartment: PDepartment {
    ...
    func showButtons(view: UIView, stackView: UIStackView, viewController: UIViewController) {
        let edit = UIImageView(frame: CGRect(x: 0, y: stackView.frame.maxY + 20, width: 100, height: 100))
        ...
        case 1:
            let clean = UIImageView(frame: CGRect(x: edit.frame.maxX, y: stackView.frame.maxY + 20, width: 100, height: 100))
        ...
        case 2:
            let room = UIImageView(frame: CGRect(x: edit.frame.maxX, y: stackView.frame.maxY + 20, width: 100, height: 100))
        ...
        case 3:
            let food = UIImageView(frame: CGRect(x: edit.frame.maxX, y: stackView.frame.maxY + 20, width: 100, height: 100))
        ...
        case 4:
            let checkout = UIImageView(frame: CGRect(x: edit.frame.maxX, y: stackView.frame.maxY + 20, width: 100, height: 100))
            ...
            let traffic = UIImageView(frame: CGRect(x: checkout.frame.maxX, y: stackView.frame.maxY + 20, width: 100, height: 100))
        ...
        default:
            let roomViews = UIImageView(frame: CGRect(x: edit.frame.maxX, y: stackView.frame.maxY + 20, width: 100, height: 100))
            ...
            let events = UIImageView(frame: CGRect(x: roomViews.frame.maxX, y: stackView.frame.maxY + 20, width: 100, height: 100))
